...
public class BorrowHistory extends Application {
    ...
    public void start (Stage primaryStage) throws Exception{
        ...
        TableColumn thirdBorrowedOnCol = new TableColumn( "Borrowed On" );
        TableColumn fourthExpectedReturnCol = new TableColumn( "Expected Return" );
        TableColumn fifthReturnedCol = new TableColumn( "Returned On" );
        TableColumn sixthFineCol = new TableColumn( "Fine" );

        table.getColumns().addAll( firstIdCol,secondBookNameCol, thirdBorrowedOnCol,fourthExpectedReturnCol,fifthReturnedCol,sixthFineCol);
