    ...
    public void start(Stage primaryStage)
    {
        ...
        submit.setOnAction( new EventHandler <ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (namet.getText().equals("") || emailt.getText().equals("") || mobnot.getText().equals("") || addresst.getText().equals("") || new String( pwdt.getText()).equals("") || new String( pwdc.getText()).equals("")  ){
                    Alert alert = new Alert( Alert.AlertType.ERROR);
                    alert.setTitle( "Registration Form" );
                    alert.setContentText("Please check all Box");
                    alert.showAndWait();
                }
                else if (!new String( pwdt.getText() ).equals( new String( pwdc.getText() ) )){
